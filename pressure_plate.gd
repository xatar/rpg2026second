...
@onready var audio_activate:AudioStream = preload("res://2d game assets/lever-01.wav")
@onready var audio_deactivate:AudioStream = preload("res://2d game assets/lever-02.wav")
